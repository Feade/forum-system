...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        ,imagePath: "http://192.168.43.117/forum-system/Public/umeditor/php/"
        ...
        ,toolbar:[
            ...
            'justifyleft justifycenter justifyright justifyjustify |',
            'link unlink | emotion image | horizontal print preview fullscreen', 'formula'
        ]
        ...
        // ,initialContent:'请开始你的表演! (提示：数学公式不支持中文输入)'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
