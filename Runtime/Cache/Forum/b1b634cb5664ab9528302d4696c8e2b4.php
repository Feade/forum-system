...
<body>
	<br><br><br>
	<form action="<?php echo U('Forum/MainPost/searchMain');?>" method="post" class="form-horizontal" name="myForm" onsubmit="return validateForm();" id="form">
	...
	<?php if(is_array($list_post)): foreach($list_post as $key=>$it): ?><div class="item" id="first-item">
			...
			<div class="feed-meta">
				...
				<h3 style="margin-left: 70%;" id="pageBar"><?php echo ($page); ?></h3>
	          ...
	          $('#pageBar a').click(function(){
	          	...
	          	tmpHref = tmpHref.replace(/\/for_title\//,"");
