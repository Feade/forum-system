				...
				<div class="feed-meta">
					<div class="zm-item-meta answer-actions clearfix js-contentActions">
						<div class="zm-meta-panel">
							<span itemprop="url" class="answer-date-link meta-item" data-tooltip="" target="_blank" style="margin-left: 20px;">编辑于：<?php echo ($it["for_time"]); ?></span>
							...
							<span id="r_">
								...
								<span class="zg-bull zu-autohide">&bull;&#12288;<?php echo ($it["for_up"]); ?>&#12288;赞&#12288;</span>
								...
								&bull;&#12288;
								<a class="dele" id="sure_<?php echo ($it["for_num"]); ?>" href="<?php echo U('Forum/UserDetail/deletePost');?>?delete_main_num=<?php echo ($it["for_num"]); ?>&delete_true=0"><font color="red">确认删除</font></a>
							</span>
						</div>
					</div>
				</div>
