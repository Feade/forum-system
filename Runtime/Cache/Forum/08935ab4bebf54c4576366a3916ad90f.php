...
<div class="login-background">
	<form action="<?php echo U('Forum/Login/login');?>" method="post" style="width: 300px;height: 200px; margin-top: 0px; margin-left: 40%;" name="myForm" onsubmit="return checkForm();">
		<br><br>
		...
		<div style="float: right;margin-top: 20px;"><a href="<?php echo U('Forum/MainPost/index');?>" style="color: #333333;" title="游客浏览">游客浏览</a><span>&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;</span><a href="<?php echo U('Forum/Adm/login');?>" style="color: #333333;" title="后台管理登陆入口">我是管理员</a></div>
	</form>
</div>
...
<script type="text/javascript">
	function checkForm()
	{
		var id=document.forms["myForm"]["name"].value;
